        ...
        <div class="section-padding gray-bg">
            <div class="container">
                    ...
                    <p> le détails ici : <br><br>
                      ...
                      echo
                      "raison ".$_POST['raison']." -<br> ".
                      "adresse ".$_POST['adresse']." -<br> ".
                      "forme ".$_POST['forme']." -<br> ".
                      "siren ".$_POST['siren']." -<br> ".
                      "capital ".$_POST['capital']." -<br> ".
                      "creation ".$_POST['creation']." -<br> ".
                      "telephone ".$_POST['telephone']." -<br> ".
                      "telecopie ".$_POST['telecopie']." -<br> ".
                      "email ".$_POST['email']." -<br> ".
                      "website ".$_POST['website']." -<br> ".
                      "agences ".$_POST['agences']." -<br> ".
                      "immatriculation ".$_POST['immatriculation']." -<br> ".
                      ...
                      "adresse_b ".$_POST['adresse_b']." -<br> ".
                      "file 1 ".$_FILES['file1']['tmp_name'].$_FILES['file1']['name'].$_FILES['file1']['error']." - <img src='".$_FILES['file1']['tmp_name']."'>e<br> ".
                      "file 2 ".$_FILES['file2']['tmp_name'];
                      ?>
                    </p>
            </div>
        </div>
